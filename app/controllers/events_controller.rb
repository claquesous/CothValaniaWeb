class EventsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @event.save
        format.html { redirect_to @event, notice: "#{@config.events.singularize.capitalize} was successfully created." }
  ...
  def update
    ...
    respond_to do |format|
      if @event.update_attributes(params[:event])
        format.html { redirect_to @event, notice: "#{@config.events.singularize.capitalize} was successfully updated." }
