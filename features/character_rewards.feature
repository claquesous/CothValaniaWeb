Feature: Setting rewards wish lists
  ...
  Scenario: Add rewards with two characters
    ...
    And I click "Save"
    Then I should see "1. Bottle of Flintstones Vitamines 0.0 Claquesous" within "wishlist"
    And I should see "2. Single Soggy Sneaker 0.0 Montparnasse" within "wishlist"
