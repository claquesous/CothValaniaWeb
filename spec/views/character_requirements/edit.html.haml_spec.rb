...
describe "character_requirements/edit" do
  ...
  it "renders the edit character_requirement form" do
    ...
    assert_select "form", :action => character_requirements_path(@character_requirement), :method => "post" do
      assert_select "input#character_requirement_obtained_event_occurrence", :name => "character_requirement[requirement_obtained_event_occurrence]"
      ...
      assert_select "input#character_requirement_used_event_occurrence", :name => "character_requirement[requirement_used_event_occurrence]"
    end
  end
end
